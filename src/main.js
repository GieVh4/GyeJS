...
//Jangan cuman pake tapi like ya bro My GyeVha

const myBot = ['u104e95aaefb53cf411f77353f6a96ece','u00bb9670a5d06c6ba423a803b5c3f776'];
const banList = [];//Banned list
var groupList = new Array();//Group list
var vx = {};var midnornama,pesane,kickhim;var waitMsg = "no";//DO NOT CHANGE THIS
const imgArr = ['png','jpg','jpeg','gif','bmp','webp'];//DO NOT CHANGE THIS
var komenTL = "AutoLike by GoogleX\nline://ti/p/~gyevha2"; //Comment for timeline
...
http://line.me/ti/p/~gyevha 👀";
    ...
    poll(operation) {
		...
		if(operation.type == 5 && this.stateStatus.salam == 1) {//someone adding me..
            let halo = new Message();
			halo.to = operation.param1;
			halo.text = "􀰂􀰂﴾ᴍ̶̲̅ᴀ̶̲̅ɴ̶̲̅﴿􏿿 Creator : line.me/ti/p/~gyevha2 ";
			this._client.sendMessage(0, halo);
        }
        ...
        if(operation.type == 19 && !isAdminOrBot(operation.param2)) { //ada kick
            ...
            if(isAdminOrBot(operation.param3)) {
				...
				if(!isAdminOrBot(operation.param2)){
					kasihtau.text = "Jangan Main Kick Kaya Jagoan Bae Luh !";
				    this._client.sendMessage(0, kasihtau);
				}
...
\n";
        ...
        if(txt === 'brisik' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
