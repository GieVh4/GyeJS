...
const myBot = ['Mid Lu taro sini bro kalo botnya mau jadi admin sakalian taro disini'];
...
\n";
        ...
        if(txt === '!dih' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
